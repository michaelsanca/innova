...
<body>
    ...
    <div class="body_wrap">
        ...
        <main>
           <!-- page title start -->
           <div class="page-title-area section-notch pt-170 pb-170" data-background="assets/img/bg/slide-02.png">
                        ...
                        <div class="contact__info--item text-center mt-30">
                            <div class="icon">
                                <svg width="65" height="68" viewBox="0 0 65 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M20.9239 16.3388H27.5337C28.3449 16.3388 29.0025 15.6558 29.0025 14.8132C29.0025 13.9706 28.3449 13.2876 27.5337 13.2876H20.9239C20.1127 13.2876 19.4551 13.9706 19.4551 14.8132C19.4551 15.6558 20.1127 16.3388 20.9239 16.3388Z" fill="rgb(115, 10, 12)"/>
                                    <path d="M20.9239 23.2041H44.4255C45.2368 23.2041 45.8944 22.521 45.8944 21.6784C45.8944 20.8358 45.2368 20.1528 44.4255 20.1528H20.9239C20.1127 20.1528 19.4551 20.8358 19.4551 21.6784C19.4551 22.521 20.1127 23.2041 20.9239 23.2041Z" fill="rgb(115, 10, 12)"/>
                                    <path d="M45.8942 28.5437C45.8942 27.7011 45.2366 27.0181 44.4254 27.0181H20.9239C20.1127 27.0181 19.4551 27.7011 19.4551 28.5437C19.4551 29.3863 20.1127 30.0693 20.9239 30.0693H44.4255C45.2366 30.0693 45.8942 29.3863 45.8942 28.5437Z" fill="rgb(115, 10, 12)"/>
                                    </g>
                                    <defs>
                            ...
                            <h3 class="title">Dirección de correo electrónico</h3>
                            <a href="academiapreuniversitariainnova@gmail.com">academiapreuniversitariainnova
                            @gmail.com</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="contact-from-inner mb--none-140">
                            <form class="contact-from" action="#!">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-field">
                                            <input type="number" name="number" id="number" placeholder="Escribe tu número">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="input-field">
                                            <textarea name="message" id="message" cols="30" rows="10" placeholder="Escribe tu masaje"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="contact-btn text-center">
                                            <button class="thm-btn" type="submit">Enviar masaje</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <iframe src="https://www.google.com/maps?q=Jr.%20Francisco%20Garcia%20Calderon%20130,%20Sicuani%2008254&t=&z=13&ie=UTF8&iwloc=&output=embed" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
        <!-- google map end -->
