                    ...
                    <div class="col-xl-12">
                        <div class="page-title">
                            ...
                            <div class="breadcrumb-list text-left">
                                <ul>
                                    <li><a href="index.html">Corporacion Educativa Pre-Universitaria</a></li>
                                    <li>INNOVA</li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row align-items-center mt-none-25">
                    <div class="col-lg-6">
                        <div class="about-image mt-25">
                            <img src="assets/img/about/foto1.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-content-two pl-50 mt-25">
                            <div class="section-title mb-30">
                                <h2 class="title">Academia Pre-Universitaria Innova Superando a los Demas </h2>
                                <p>La academia preuniversitaria Innova Nivel-A se destaca por su enfoque integral en la preparación de estudiantes para los desafíos del examen de admisión a la universidad. Con un plan de estudios actualizado, docentes altamente capacitados y métodos de enseñanza innovadores, Innova ofrece a sus estudiantes las herramientas necesarias para potenciar sus habilidades académicas, mejorar su rendimiento y asegurar su ingreso exitoso a la universidad. Su compromiso con la excelencia y el acompañamiento constante asegura que cada estudiante esté preparado para dar lo mejor de sí en el proceso de admisión.</p>
                            </div>
                            <ul class="about-features">
                                <li>Plana de docentes altamente capacitada</li>
                                <li>Control estricto del progreso</li>
                                <li>Exámenes semanales</li>
                                <li>Avance paralelo al CEPRU</li>
                                <li>Internado Innova</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="video-area pt-120">
            <div class="container">
                <div class="video-image pos-rel">
                    ...
                    <a class="popup-video video-icon" href="https://www.youtube.com/watch?v=bS4aKfGnGa4"><i class="far fa-play"></i></a>
                </div>
            </div>
        </section>
        <!-- video end -->
